...
**Section 13 foundation (steps 1–8) complete.** 108 tests green; iOS compile + `androidApp:assembleDebug` clean throughout. Next: real Compose UI, on-device engines (Gemini Nano / Apple Foundation Models), remaining entities + `.sqm` migrations, the content pipeline, Progress/Library screens.
